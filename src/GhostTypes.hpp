...
public:
    ...
    // IMPORTANT: parentLayer must always be freshly fetched (e.g. this->m_objectLayer
    // at the call site) - caching it across resets caused respawned sprites
    // to get added to a stale, no-longer-visible layer instance.
